...
function buildContext(user) {
    ...
    const openReports = user.reports.filter((r) => r.status === "OPEN").length;
    const inProgressReports = user.reports.filter((r) => r.status === "IN_PROGRESS").length;
    const fixedReports = user.reports.filter((r) => r.status === "FIXED").length;
    return `
=========================
USER PROFILE
=========================
